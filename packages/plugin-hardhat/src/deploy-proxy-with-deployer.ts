...
export interface DeployWithDeployer {
...
export function makeDeployProxyWithDeployer(hre: HardhatRuntimeEnvironment): DeployWithDeployer {
  return async function deployProxy(
    ...
    const deployer = await ImplFactory.signer.getAddress();
